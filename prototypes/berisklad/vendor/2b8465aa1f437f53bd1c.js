...
(() => {
  ...
  function load() {
    ...
    loadP = fetch('data:application/json,%7B%7D')
  ...
  const stylesheet =
    ...
    ':host([minimal]) .empty .cap,:host([minimal]) .empty .sub{display:none}' +
    ':host([minimal]) .empty svg{width:15px;height:15px}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      this._ctl = root.querySelector('.ctl'); this._ctl.inert=true; this._ctl.setAttribute('aria-hidden','true'); this._ctl.style.setProperty('display','none','important');
